...
out_root_dir = ['E:/stl10/stl_bpg_deldpc_reighlay_',num2str(snr),'dB'];   %经过信道编码、调制、awgn、解调、信道解码后的比特文件
mkdir(out_root_dir);
...
%对读取出的列向量进行ldpc编码、qam调制、rayleigh信道、qam解调、ldpc解码，返回解码数据
